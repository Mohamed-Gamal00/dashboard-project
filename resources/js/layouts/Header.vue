    ...
    <div class="container-fluid">
        <div class="main-header-left">
            <div class="responsive-logo">
                <a href="index.html"
                    ><img
                        src="/dashboard/assets/img/brand/logo.png"
                        class="logo-1"
                        alt="logo"
                /></a>
                <a href="index.html"
                    ><img
                        src="/dashboard/assets/img/brand/logo-white.png"
                        class="dark-logo-1"
                        alt="logo"
                /></a>
                <a href="index.html"
                    ...
                    <div class="dropdown nav-itemd-none d-md-flex">
                        ...
                        >
                            <span
                                ...
                                ><img
                                    src="/dashboard/assets/img/flags/us_flag.jpg"
                                    alt="img"
                            /></span>
                            <div class="my-auto">
                        ...
                        >
                            <a href="#" class="dropdown-item d-flex">
                                <span
                                    ...
                                    ><img
                                        src="/dashboard/assets/img/flags/french_flag.jpg"
                                        alt="img"
                                /></span>
                                <div class="d-flex">
                            ...
                            <a href="#" class="dropdown-item d-flex">
                                <span
                                    class="avatar ml-3 align-self-center bg-transparent"
                                    ><img
                                        src="/dashboard/assets/img/flags/germany_flag.jpg"
                                        alt="img"
                                /></span>
                                <div class="d-flex">
                            ...
                            <a href="#" class="dropdown-item d-flex">
                                <span
                                    class="avatar ml-3 align-self-center bg-transparent"
                                    ><img
                                        src="/dashboard/assets/img/flags/italy_flag.jpg"
                                        alt="img"
                                /></span>
                                <div class="d-flex">
                            ...
                            <a href="#" class="dropdown-item d-flex">
                                <span
                                    class="avatar ml-3 align-self-center bg-transparent"
                                    ><img
                                        src="/dashboard/assets/img/flags/russia_flag.jpg"
                                        alt="img"
                                /></span>
                                <div class="d-flex">
                            ...
                            <a href="#" class="dropdown-item d-flex">
                                <span
                                    class="avatar ml-3 align-self-center bg-transparent"
                                    ><img
                                        src="/dashboard/assets/img/flags/spain_flag.jpg"
                                        alt="img"
                                /></span>
                                <div class="d-flex">
            ...
            <div class="nav nav-item navbar-nav-right ml-auto">
                            ...
                            <span class="input-group-btn">
                                ...
                                >
                                    <svg
                                        ...
                                        class="header-icon-svgs feather feather-search"
                                        viewBox="0 0 24 24"
                                        fill="none"
                                        stroke="currentColor"
                                        stroke-width="2"
                ...
                <div class="dropdown nav-item main-header-message">
                    <a class="new nav-link" href="#"
                        ><svg
                            xmlns="http://www.w3.org/2000/svg"
                            class="header-icon-svgs feather feather-mail"
                            viewBox="0 0 24 24"
                            fill="none"
                            stroke="currentColor"
                            stroke-width="2"
                        ...
                        <div class="main-message-list chat-scroll">
                            <a href="#" class="p-3 d-flex border-bottom">
                                <div
                                    ...
                                    data-image-src="/dashboard/assets/img/faces/3.jpg"
                                >
                                ...
                                <div class="wd-90p">
                                    ...
                                    <p class="mb-0 desc">
                                        I'm sorry but i'm not sure how to help
                                        you with that......
                                    </p>
                                    <p
                            ...
                            <a href="#" class="p-3 d-flex border-bottom">
                                <div
                                    class="drop-img cover-image"
                                    data-image-src="/dashboard/assets/img/faces/2.jpg"
                                >
                                    <span class="avatar-status bg-teal"></span>
                                </div>
                                <div class="wd-90p">
                            ...
                            <a href="#" class="p-3 d-flex border-bottom">
                                <div
                                    class="drop-img cover-image"
                                    data-image-src="/dashboard/assets/img/faces/9.jpg"
                                >
                                    <span class="avatar-status bg-teal"></span>
                                </div>
                                <div class="wd-90p">
                            ...
                            <a href="#" class="p-3 d-flex border-bottom">
                                <div
                                    class="drop-img cover-image"
                                    data-image-src="/dashboard/assets/img/faces/12.jpg"
                                >
                                    <span class="avatar-status bg-teal"></span>
                                </div>
                                <div class="wd-90p">
                            ...
                            <a href="#" class="p-3 d-flex border-bottom">
                                <div
                                    class="drop-img cover-image"
                                    data-image-src="/dashboard/assets/img/faces/5.jpg"
                                >
                                    <span class="avatar-status bg-teal"></span>
                                </div>
                                <div class="wd-90p">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <div class="main-notification-list Notification-scroll">
                            <a class="d-flex p-3 border-bottom" href="#">
                                ...
                                <div class="mr-auto">
                                    <i
                                        class="las la-angle-left text-left text-muted"
                                    ></i>
                                </div>
                            </a>
                ...
                <div class="nav-item full-screen fullscreen-button">
                    <a class="new nav-link full-screen-link" href="#"
                        ><svg
                            xmlns="http://www.w3.org/2000/svg"
                            class="header-icon-svgs feather feather-maximize"
                            viewBox="0 0 24 24"
                            fill="none"
                            stroke="currentColor"
                            stroke-width="2"
                        ...
                        <div class="main-header-profile bg-primary p-3">
                            <div class="d-flex wd-100p">
                                <div class="main-img-user">
                                    <img
                                        alt=""
                                        src="/dashboard/assets/img/faces/6.jpg"
                                        class=""
                                    />
                                </div>
